...
[![Version](https://img.shields.io/badge/version-1.19.0-blue)](https://github.com/zhixuli0406/DuDuClaw/releases)
...
インストール完了後、対応プラットフォームのプリコンパイル済み binary が自動でダウンロードされます（macOS ARM64/x64、Linux x64/ARM64、Windows x64 をサポート）。
...
DuDuClaw の進化エンジン（Skill Vetter）と一部のチャネルブリッジは Python 環境を必要とします：
...
- [docs/evolution-engine.md](docs/evolution-engine.md) — Evolution Engine v2 設計ドキュメント
- [docs/deployment-guide.md](docs/deployment-guide.md) — 本番環境デプロイガイド
- [docs/development-guide.md](docs/development-guide.md) — 開発者設定と Agent 開発
